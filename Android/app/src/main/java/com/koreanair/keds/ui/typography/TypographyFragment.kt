package com.koreanair.keds.ui.typography
...
import com.koreanair.keds.databinding.FragmentTypographyBinding
...
class TypographyFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val galleryViewModel =
            ViewModelProvider(this).get(TypograhyViewModel::class.java)

        _binding = FragmentTypographyBinding.inflate(inflater, container, false)
        val root: View = binding.root

        val textView: TextView = binding.textTypography
